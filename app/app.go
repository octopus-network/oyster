...
import (
	...
	ccvconsumer "github.com/octopus-network/interchain-security/x/ccv/consumer"
	consumerkeeper "github.com/octopus-network/interchain-security/x/ccv/consumer/keeper"
	ccvconsumertypes "github.com/octopus-network/interchain-security/x/ccv/consumer/types"
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		crisistypes.StoreKey, slashingtypes.StoreKey, govtypes.StoreKey, paramstypes.StoreKey,
		ibcexported.StoreKey, upgradetypes.StoreKey, feegrant.StoreKey, evidencetypes.StoreKey,
		ibctransfertypes.StoreKey, capabilitytypes.StoreKey, consensusparamtypes.StoreKey, ccvconsumertypes.StoreKey,
	)
	...
	// initialize BaseApp
	anteHandler, err := consumer.NewAnteHandler(
		consumer.HandlerOptions{
